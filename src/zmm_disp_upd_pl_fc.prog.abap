...
SELECT * FROM ZSD_PL_SALE_FC INTO CORRESPONDING FIELDS OF TABLE IT_FINAL WHERE  VKORG IN SO_VKORG
...
FORM USER_COMMAND USING CODE LIKE SY-UCOMM
 ...
 IF CODE = '&DATA_SAVE'.
  ...
  UPDATE  ZSD_PL_SALE_FC  FROM WA_FINAL1.
