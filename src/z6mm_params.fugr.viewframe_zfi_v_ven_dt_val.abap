*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZFI_V_VEN_DT_VAL
*   generation date: 21.05.2020 at 16:15:06
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZFI_V_VEN_DT_VAL    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZFI_V_VEN_DT_VAL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZFI_V_VEN_DT_VAL_EXTRACT
TOTAL = ZFI_V_VEN_DT_VAL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZFI_V_VEN_DT_VAL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZFI_V_VEN_DT_VAL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFI_V_VEN_DT_VAL_EXTRACT
TOTAL = ZFI_V_VEN_DT_VAL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZFI_V_VEN_DT_VAL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZFI_V_VEN_DT_VAL'
...
TOTAL = ZFI_V_VEN_DT_VAL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZFI_V_VEN_DT_VAL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZFI_V_VEN_DT_VAL-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZFI_V_VEN_DT_VAL'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZFI_V_VEN_DT_VAL-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZFI_V_VEN_DT_VAL_EXTRACT
TOTAL = ZFI_V_VEN_DT_VAL_TOTAL
