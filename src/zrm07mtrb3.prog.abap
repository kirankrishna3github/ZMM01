...
REPORT zrm07mtrb3 MESSAGE-ID m7.
...
***** End Code: Added by CS on 28.10.2015 for Authorization Object. *****
  ...
  IF bestand[] IS NOT INITIAL.
    LOOP AT bestand.
      ls_falv1-ebeln = bestand-ebeln.
      ls_falv1-ebelp = bestand-ebelp.
      ls_falv1-matnr = bestand-matnr.
      ls_falv1-menge = bestand-menge.
      ls_falv1-meins = bestand-meins.
      APPEND ls_falv1 TO lt_falv1.
      CLEAR ls_falv1.
    ENDLOOP.
  ENDIF.

  EXPORT lt_falv1 FROM lt_falv1 TO MEMORY ID 'ZMB5T_NK1'.   " added by NK 06.10.2016
