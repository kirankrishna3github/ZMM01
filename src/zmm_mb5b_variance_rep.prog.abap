*&---------------------------------------------------------------------*
*& Report  ZMM_MB5B_VARIANCE_REP                                       *
*&                                                                     *
*&---------------------------------------------------------------------*
*& Program Name        :  ZMM_MB5B_VARIANCE_REP                        *
*& Creation Date       :  Sep 26, 2016                                 *
*& Author              :  Naren Karra                                  *
*& Functional          :  Ashish Kothari(KPMG)                         *
*& Application Area    :  MB5B Variance Report                         *
*& Development Spec ID :                                               *
*&---------------------------------------------------------------------*
*& Description:        :  MB5B Variance Overview / Detail Report       *
*& Inputs              :                                               *
*& Outputs             :                                               *
...
*& Sep 26, 2016  | IRDK925826            | IBM_AMS    | Initial        *
*&                                                      Development    *
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
*
*   CHANGED BY: Naren Karra
*   CHANGE ON: 28.09.2016
*   REASON FOR CHANGE: For SKU Variance
*   REQUEST #: IRDK925874
* --------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
*
*   CHANGED BY: Naren Karra
*   CHANGE ON: 29.09.2016
*   REASON FOR CHANGE: Movement Type logic
*   REQUEST #: IRDK925888
* --------------------------------------------------------------------*
REPORT  zmm_mb5b_variance_rep.
TYPE-POOLS:slis.
...
PARAMETERS: p_over   TYPE c RADIOBUTTON GROUP g1 DEFAULT 'X' USER-COMMAND usr1.
PARAMETERS: p_detail TYPE c RADIOBUTTON GROUP g1.
SELECTION-SCREEN SKIP.
SELECTION-SCREEN BEGIN OF BLOCK b05 WITH FRAME TITLE text-b05.
PARAMETERS: p_sku1   TYPE c RADIOBUTTON GROUP g2 DEFAULT 'X' USER-COMMAND usr2 MODIF ID m1.
PARAMETERS: p_sku2   TYPE c RADIOBUTTON GROUP g2 MODIF ID m1.
SELECTION-SCREEN END OF BLOCK b05.
SELECTION-SCREEN END OF BLOCK b01.

* Selection Screen Block 2
SELECTION-SCREEN BEGIN OF BLOCK b02 WITH FRAME TITLE text-b02.
PARAMETERS: p_werks1 TYPE ekpo-werks MODIF ID m1.
SELECT-OPTIONS: s_budat1 FOR gv_budat MODIF ID m1 OBLIGATORY.
...
PARAMETERS: p_matnr  TYPE mara-matnr MODIF ID m2,
...
*        lv_date_high(10).
  ...
  ELSEIF p_detail = 'X'.
    CLEAR hline.
    hline-typ  = 'H'.
    hline-info = '       Variance Detail  '.                "#EC NOTEXT
