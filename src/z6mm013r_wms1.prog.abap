...
REPORT  z6mm013r_wms1.
*----------------------------------------------------------------------*
* OBJECT DESCRIPTION:
* OBJECT TYPE       :                 FUNC. CONSULTANT  : Mr.Kamalakar Varma
*  DEVELOPER:Pravin
...
*      CLEAR WA_Z6MMA_WMS_MM.
*    ELSE.
    MODIFY it_z6mma_wms_mm FROM wa_z6mma_wms_mm TRANSPORTING container description.
*    ENDIF.
  ENDLOOP.
...
*  SORT IFINAL BY MBLNR MJAHR.
    ...
    LOOP AT it_mseg1 INTO wa_mseg1.
      ...
      ELSE.
        ...
        wa_z6mma_wms_out-lgort     = wa_mseg1-lgort.
        " Anees
...
*      ENDIF.
      ...
      MODIFY it_z6mma_wms_out FROM wa_z6mma_wms_out TRANSPORTING container description.
...
*      WA_z6mma_wms_in-GR_NO     = WA_MSEG_IN1-MBLNR.
      ...
      wa_z6mma_wms_in-lgort     = wa_mseg_in1-lgort.
    ENDIF.
...
*      ENDIF.
    ...
    MODIFY it_z6mma_wms_in FROM wa_z6mma_wms_in TRANSPORTING container description expiry_date.
