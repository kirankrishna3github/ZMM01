...
TYPES: BEGIN OF t_mara,  " Added by CS on 30.03.2016
      ...
      END OF t_mara.
TYPES: BEGIN OF ty_tspat,   " added by nk on 16.01.2017
        spart TYPE spart,
       END OF ty_tspat.
************************************************************************
...
DATA: wa_tspat TYPE ty_tspat,
      i_tspat TYPE STANDARD TABLE OF ty_tspat,
      wa_out_10 TYPE t_output,          " added by nk on 16.01.2017
      it_out_10 TYPE TABLE OF t_output. " added by nk on 16.01.2017
...
DATA: lv_ekorg_auth_flg TYPE c VALUE '',  " Auth. Flag for Purchase Org.
      ...
      lv_auth_spart_flg TYPE c VALUE ''   " added by nk on 16.01.2017
.
